...
<html xml:lang="zh-CN" xmlns="http://www.w3.org/1999/xhtml" lang="zh-CN"><head>
    ...
    <link rel="stylesheet" type="assets/text/css" href="assets/css/jquery.css" media="screen">
...
<div id="OSC_Screen"><!-- #BeginLibraryItem "/Library/OSC_Banner.lbi" -->
    ...
    <div id="OSC_Content"><div class="SpaceChannel">
            ...
            <div id="lnks">
                <strong><strong><?php $user = $this->session->userdata('user');
                        if(isset($user)){
                            echo $user->username."'s Blog";
                        }?></strong>
        ...
        <div class="BlogList">
            <ul>
                ...
                <li class="Blog" id="blog_24027">
                    <h2 class="BlogAccess_true BlogTop_0"><a href="User/viewPost_comment?id=<?php echo $article->article_id?>"><?php echo $article->title?></a></h2>
                    <div class="outline">
                        <span class="time">发表于 <?php echo $article->post_date?></span>
                        <span class="catalog">分类: <a href="#"><?php echo $article->type_name?></a></span>
                        <span class="stat">统计: 1评/<?php echo $article->clicked?>阅</span>
        ...
        <div class="BlogMenu"><div class="admin SpaceModule">
                ...
                <ul class="LinkLine">
                    ...
                    <li><a href="User/editCatalog">博客分类管理</a></li>
