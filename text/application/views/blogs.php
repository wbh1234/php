        ...
        <div id="AdminScreen">
            ...
            <div id="AdminContent">
                <div class="MainForm BlogArticleManage">
                    <h3 class="title">共有 <?php echo $total?> 篇博客，每页显示 4个，共 <?php echo ceil($total/4)?> 页</h3>
                    <div id="BlogOpts">
                        ...
                        <a href="javascript:;" id="del_btn">删除选中</a>
                    </div>
                    <ul>
                ...
                <script type="text/javascript">
                    $('#del_btn').on('click',function(){
                        ...
                        $.get('User/del_article',{
                            ids:ids
                        },function(data){
                            if(data == 'success'){
                                location.href = 'User/blogs';
                            }
                        },'text');
                    });
